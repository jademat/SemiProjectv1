...
public class BoardMapperTest {
    ...
    void findTest() {
        ...
        params.put("findkey","웹툰");

       // When : 데이터로 테스트할 기능 호출
        /*List<BoardDTO>results = boardMapper.selectFindBoard(0,35,"contents","");*/
        //List<BoardDTO>results = boardMapper.selectFindBoard(0,35,"title","다");
    ...
    void countfindTest() {
        ...
        Map<String,Object> params = new HashMap<>();
        params.put("pageSize",35);
        params.put("findtype","userid");
        params.put("findkey","abc");
